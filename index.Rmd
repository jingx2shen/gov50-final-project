...
ggsave("total_doe_rnd_basic.png", width = 50, height = 25)
```
...
ggsave("total_doe_rnd_re_highlight.png")
```
...
ggsave("total_doe_rnd_by_pres.png")
```
...
ggsave("total_doe_rnd_with_re_presparty.png")
```
...
ggsave("total_doe_rnd_by_pres_and_cong.png")
```
...
ggsave("re_doe_rnd_by_pres_and_cong.png")
```
