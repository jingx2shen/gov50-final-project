...
multivarreg <- lm(total_doe_rnd ~ president_party_binary + x2 + x3, data = dataset_mut)
multivarreg

# would add variables like overall Cong budget/spending; price of gas; inflation; global energy spending; investments in DARPA-E and DARPA-C (Cong by Pres party, mixed, or not)
#* overall Cong spending 
##* vs. 1 
#* 0 chambers = 0
#* DOE spending / total spending (% of total budget) ** GOOD ** 
#* DOE vs. DOD spending 

# controlling for GDP yearly growth 

#fit <- lm(perc_lib ~ prop + factor(year) + log_pop + log_pop_denc + avg_home_val_log, data = wind)
```
