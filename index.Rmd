...
1. [DOE Budget Authority for Energy Research, Development, and Demonstration Database] (https://www.belfercenter.org/publication/database-us-department-energy-doe-budgets-energy-research-development-demonstration-1): This website contains an Excel file containing tables of appropriations by Congress to the Department of Energy from fiscal year 1978-2022. These numbers include the budget requests by the DOE to Congress each year, along with the ultimate appropriation amount from Congress, as well as the breakdowns of the agency's budget by research areas (i.e., fossil fuels, energy efficiency, hydrogen, renewable energy, nuclear energy). 

2. [U.S. Politics: Democrat vs. Republican Control of Congress and the Presidency: Political Party Overlays in Data Planet Statistical Datasets] (https://data-planet.libguides.com/politicalpartycontrol): This data encompasses the counts of House Democrats, House Republicans, and House Other Parties by seats from 1856 = 2020, alongside the analogous counts of Senate Democrats and Senate Republicans over the same time period. In my analysis, I will need to filter this data to the years for which I have data from #1, in addition to distilling the overall party in control of the House and Senate for each of my individual fiscal years of interest. 

3. [U.S. Presidents, Date Range of Term(s), and Party Affiliation] (https://gist.github.com/namuol/2657233): U.S. of all the past United States Presidents, including the starting and ending dates to their terms, their party affiliation. I will need to filter this data to Presidents whose terms align with the years for which I have data from #1, in addition to specifying the President for each individual fiscal year examined above (rather than having their term years be listed as a range).
