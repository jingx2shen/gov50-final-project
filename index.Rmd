...
multi_var_reg <- lm(total_doe_rnd ~ president_party + outlays + outlays_frac_of_gdp + crude_oil_prices + inflation + energy_consump, data = multi_var_selected)
...
# global energy consumption/spending; investments in DARPA-E and DARPA-C; Cong by Pres party, mixed, or not; GDP yearly growth; DoD spending; DOE spending out of total spending (% of total budget) 
